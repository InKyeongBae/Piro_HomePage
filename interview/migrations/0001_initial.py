    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('major', models.CharField(blank=True, choices=[('복수전공자', '복수전공자'), ('전공자', '전공자'), ('비전공자', '비전공자')], max_length=50, null=True, verbose_name='전공여부')),
                ...
                ('asking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='asking', to='interview.asking')),
            ],
            options={
                'ordering': ['-generation'],
            },
